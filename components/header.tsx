                ...
                {links.map((link) => (
                    ...
                    >
                        ...
                        {link.name === activeSection && (
                            <motion.span className='bg-blue-100 rounded-full
